...
![authent](./Parasite1.png "Notre application avec une mire d'authentification")
...
![email](./Parasite2.png "Formulaire email")
...
![new](./Parasite3.png "Nouveau cookie")
...
![png](./Parasite6.png "Png en base 64")
...
![depot](./Parasite7.png "Depot de l'image")

L'image est bien écrite sur le serveur : 

![image](./Parasite8.png "Image sur le serveur")
...
![recuperation](./Parasite9.png "Image récupération")
